export * from './single/employee-single-response.interface';
export * from './single/put/employee-put-request.interface';
export * from './single/put/employee-put-response.interface';
